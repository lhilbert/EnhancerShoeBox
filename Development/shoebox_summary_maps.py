...
if not (base_dir / "summary_contact_grouped.txt").exists():
...
# ---
# First transformations without fitting
...
first_ax = axes[0]
first_panel_norm = Normalize(vmin=manual_cmap_limits["SE-P 5% dist [nm]"][0], vmax=manual_cmap_limits["SE-P 5% dist [nm]"][1])
first_ax.scatter(
    trafo_mic_S5P,
    trafo_mic_S2P,
