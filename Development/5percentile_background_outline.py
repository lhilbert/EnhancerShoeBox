...
from scipy.spatial import ConvexHull  # <-- added for convex hull outline
...
# --------------------------
# Create background with N-neighbor weighted averaging
# --------------------------
def create_background(df, z_column, cbar_label, output_file,
                      N_neighbors=30, averaging_KK=1, grid_size=300):
...
create_background(
    ...
    output_file="5percentile_Reg-gene_background_outline_20xaveraging.svg",
    N_neighbors=30,
    averaging_KK=1
)
...
create_background(
    ...
    output_file="5percentile_Reg-promoter_background_outline_20xaveraging.svg",
    N_neighbors=30,
    averaging_KK=1
)
